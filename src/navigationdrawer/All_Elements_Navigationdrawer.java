...
public class All_Elements_Navigationdrawer {
 ...
 public By Nevigation_Login = By.id("com.grofers.customerapp:id/text_login");
 public By Nevigation_My_Address = By.id("com.grofers.customerapp:id/text_my_addresses");
